...
fun AddCitizenModal(
    ...
    ModalBottomSheet(onDismissRequest = onDismiss) {
        Column(
            ...
            Text("Add New Citizen", style = MaterialTheme.typography.headlineSmall.copy(fontWeight = FontWeight.Bold))
            ...
            OutlinedTextField(
                ...
                onValueChange = { onEvent(CitizenFormEvent.HouseholdIdChanged(it)) },
            ...
            Button(
                ...
                Text("Save Citizen", style = MaterialTheme.typography.bodyLarge.copy(fontWeight = FontWeight.Bold))
            }
            Spacer(modifier = Modifier.height(16.dp))
        }
    }
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun AddHouseholdModal(
    onDismiss: () -> Unit,
    onSave: (Household) -> Unit
) {
    ...
    ModalBottomSheet(onDismissRequest = onDismiss) {
        Column(
            ...
            Text("Add New Household", style = MaterialTheme.typography.headlineSmall.copy(fontWeight = FontWeight.Bold))
            
            OutlinedTextField(value = id, onValueChange = { id = it }, label = { Text("Household ID") }, modifier = Modifier.fillMaxWidth())
            OutlinedTextField(value = address, onValueChange = { address = it }, label = { Text("Address") }, modifier = Modifier.fillMaxWidth())
            OutlinedTextField(value = gnDivision, onValueChange = { gnDivision = it }, label = { Text("GN Division") }, modifier = Modifier.fillMaxWidth())
            OutlinedTextField(value = headNic, onValueChange = { headNic = it }, label = { Text("Head of Household NIC") }, modifier = Modifier.fillMaxWidth())
            ...
            Button(
                ...
                Text("Save Household", style = MaterialTheme.typography.bodyLarge.copy(fontWeight = FontWeight.Bold))
            }
            Spacer(modifier = Modifier.height(16.dp))
        }
    }
...
fun AddRequestModal(
    ...
    ModalBottomSheet(onDismissRequest = onDismiss) {
        Column(
            ...
            Text("New Service Request", style = MaterialTheme.typography.headlineSmall.copy(fontWeight = FontWeight.Bold))
            
            OutlinedTextField(value = nic, onValueChange = { nic = it }, label = { Text("Citizen NIC") }, modifier = Modifier.fillMaxWidth())
            OutlinedTextField(value = type, onValueChange = { type = it }, label = { Text("Certificate Type") }, modifier = Modifier.fillMaxWidth())
