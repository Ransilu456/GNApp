...
@Composable
fun HouseholdEditScreen(householdViewModel: HouseholdViewModel, onHouseholdUpdated: () -> Unit) {
                ...
                Card(
                        ...
                        Column(
                                ...
                                OutlinedTextField(
                                        ...
                                        supportingText = {
                                                uiState.idError?.let { error -> Text(text = error) }
                                        },
                                        modifier = Modifier.fillMaxWidth(),
...
fun HouseholdEditScreenPreview() {
        GNAppTheme {
                HouseholdEditScreenContent(
                        uiState =
                                HouseholdUiState(
                                        id = PreviewData.sampleHousehold.id,
                                        address = PreviewData.sampleHousehold.address,
                                        gnDivision = PreviewData.sampleHousehold.gnDivision,
                                        headNic = PreviewData.sampleHousehold.headNic,
                                        membersCount =
                                                PreviewData.sampleHousehold.membersCount.toString(),
                                        remarks = PreviewData.sampleHousehold.remarks
                                ),
                        onIdChanged = {},
                        onAddressChanged = {},
                        onGnDivisionChanged = {},
